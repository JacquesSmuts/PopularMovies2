...
public class MovieProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
         ...
         * that it should return the CODE_MOVIE_WITH_DATE code
         */
        //matcher.addURI(authority, MovieContract.PATH_MOVIE + "/#", CODE_MOVIE_WITH_DATE);
...
//            }
    ...
    /**
     * In Sunshine, we aren't going to do anything with this method. However, we are required to
     * override it as MovieProvider extends ContentProvider and insert is an abstract method in
     * ContentProvider. Rather than the single insert method, we are only going to implement
     * {@link MovieProvider#bulkInsert}.
     *
